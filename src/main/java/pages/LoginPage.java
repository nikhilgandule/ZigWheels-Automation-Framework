...
public class LoginPage {
    ...
    public void googleLoginValidation() {
        ...
        try {
            // Click Login Icon
            WebElement loginIcon = wait.until(ExpectedConditions.elementToBeClickable(By.id("des_lIcon")));
            loginIcon.click();

            // Locate Google button
            WebElement googleBtn = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[contains(@class,'googleSignIn')]")));
